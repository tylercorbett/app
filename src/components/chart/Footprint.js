        ...
        <div className={styles.profile}>
            <div>
                <div className={styles.imgContainer}>
                    <img className={styles.img} src={tylerUrl}/>
                </div>
        ...
        <div className={styles.city}>
            <div className={styles.figure}>
                <div className={styles.imgContainerPortland}>
                    <img className={styles.imgPortland} src='https://proxy.duckduckgo.com/iu/?u=https%3A%2F%2Fwww.travelportland.com%2Fwp-content%2Fuploads%2F2014%2F09%2FDavid-Grant-Downtown.jpg&f=1'/>
                </div>
        ...
        <div className={styles.neighborhood}>
            <div className={styles.figure}>
                <div className={styles.imgContainerNeighborhood}>
                    <img className={styles.imgNeighborhood} src='https://proxy.duckduckgo.com/iu/?u=https%3A%2F%2Fcdn1.iconfinder.com%2Fdata%2Ficons%2Freal-estate-set-5%2F512%2F41-512.png&f=1'/>
                </div>
